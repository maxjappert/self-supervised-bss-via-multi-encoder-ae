...
evaluated_weights = np.load('../results/gradient_video_weights_evaluated.npy')[21:]
basis_weights = np.load('../results/gradient_video_weights.npy')[21:]
...
for metric in metrics.keys():
    ...
    ax1.set_title(f'Influence of $\lambda$ on {metric.upper()}', fontsize=16)
    ...
    fig.tight_layout()
    plt.savefig(f'gradient_weight_experiment_{metric}.png', dpi=300)
