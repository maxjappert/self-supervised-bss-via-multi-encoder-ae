...
def evaluate_video_weight(name, num_samples=128, name_video_model='video_model_raft_resnet'):
    ...
    weights = [i - 20 for i in range(40)] # np.linspace(20, -20, num=40)
...
evaluate_video_weight('', num_samples=10)
