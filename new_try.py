...
model, _, _ = train(CircleTriangleDataset(), channels=[24, 48, 96, 144, 144], batch_size=64, visualise=True, max_epochs=300, test_save_step=1, linear=False, num_encoders=3)
